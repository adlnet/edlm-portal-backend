# Generated by Django 4.2.27 on 2025-12-16 19:19
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('code_of_ethics_acknowledgement', models.BooleanField(help_text='Applicant acknowledges code of ethics', verbose_name='Code of Ethics Acknowledgement')),
                ('application_type', models.CharField(blank=True, choices=[('new', 'New Application'), ('renewal', 'Renewal Application')], help_text='Type of application: New or Renewal', max_length=20)),
                ('position', models.CharField(blank=True, choices=[('SAPR_VA', 'SAPR VA (Victim Advocate)'), ('SARC/SAPR_PM', 'SARC / SAPR PM')], help_text='Position being applied for: SAPR VA or SARC / SAPR PM', max_length=20)),
                ('status', models.CharField(blank=True, choices=[('draft', 'Draft'), ('submitted', 'Submitted'), ('under_review', 'Under Review'), ('approved', 'Approved'), ('rejected', 'Rejected')], default='draft', help_text='Current status of the application', max_length=50)),
                ('policy', models.CharField(blank=True, default='dod-xxxx', help_text='Policy reference number', max_length=100)),
                ('application_version', models.IntegerField(blank=True, default=1, help_text='Version number of the application')),
                ('first_name', models.CharField(blank=True, max_length=255, validators=[django.core.validators.RegexValidator(message='Invalid character used', regex='^([\\x09\\x0A\\x0D\\x20-\\x7E]|[\\xC2-\\xDF]|[\\xE0\\xA0-\\xBF]|[\\xE1-\\xEC\\xEE\\xEF]{2}|[\\xED\\x80-\\x9F]|[\\xF0\\x90-\\xBF]{2}|[\\xF1-\\xF3]{3}|[\\xF4\\x80-\\x8F]{2})*$')])),
                ('last_name', models.CharField(blank=True, max_length=255, validators=[django.core.validators.RegexValidator(message='Invalid character used', regex='^([\\x09\\x0A\\x0D\\x20-\\x7E]|[\\xC2-\\xDF]|[\\xE0\\xA0-\\xBF]|[\\xE1-\\xEC\\xEE\\xEF]{2}|[\\xED\\x80-\\x9F]|[\\xF0\\x90-\\xBF]{2}|[\\xF1-\\xF3]{3}|[\\xF4\\x80-\\x8F]{2})*$')])),
                ...
                ('no_experience_needed', models.BooleanField(blank=True, default=False, help_text='Check if no experience is needed for this application')),
                ...
                ('final_submission', models.BooleanField(blank=True, default=False, help_text='Indicates the application has been submitted')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('completion_date', models.DateField(blank=True, help_text='Date when the course was completed')),
                ('clocked_hours', models.DecimalField(blank=True, decimal_places=2, default=0.0, help_text='Number of hours for this course', max_digits=6)),
                ...
                ('xds_course', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='application_courses', to='external.course')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('modified', model_utils.fields.AutoLastModifiedField(default=django.utils.timezone.now, editable=False, verbose_name='modified')),
                ('id', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False)),
                ('comment', models.TextField(blank=True, help_text='Comment text', validators=[django.core.validators.RegexValidator(message='Invalid character used', regex='^([\\x09\\x0A\\x0D\\x20-\\x7E]|[\\xC2-\\xDF]|[\\xE0\\xA0-\\xBF]|[\\xE1-\\xEC\\xEE\\xEF]{2}|[\\xED\\x80-\\x9F]|[\\xF0\\x90-\\xBF]{2}|[\\xF1-\\xF3]{3}|[\\xF4\\x80-\\x8F]{2})*$')])),
                ...
                ('reviewer', models.ForeignKey(help_text='The user who wrote this comment', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='application_comments', to=settings.AUTH_USER_MODEL)),
            ],
            options={
